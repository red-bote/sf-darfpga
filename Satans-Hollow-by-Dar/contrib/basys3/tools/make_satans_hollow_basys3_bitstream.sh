#!/bin/bash
# Drive Vivado to synthesise and build the Satan's Hollow Basys3 bitstream.
#
...
#   vhdl_satans_hollow_rev_0_2_2019_11_22/basys3/satans_hollow_basys3.runs/impl_1/satans_hollow_basys3.bit
#
...
XPR="$ROOT/vhdl_satans_hollow_rev_0_2_2019_11_22/basys3/satans_hollow_basys3.xpr"
...
WORK=/tmp/satans_hollow_bitstream
mkdir -p "$WORK"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_satans_hollow_rev_0_2_2019_11_22/basys3/satans_hollow_basys3.runs/impl_1/satans_hollow_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else
