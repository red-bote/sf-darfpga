...
##Pmod Header JA  (joystick: JA1=left, JA2=right, JA4=shield/up, JA7=fire)
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33  PULLUP true } [get_ports {JA[0]}];#Sch name = JA1  (left)
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33  PULLUP true } [get_ports {JA[1]}];#Sch name = JA2  (right)
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33  PULLUP true } [get_ports {JA[2]}];#Sch name = JA3  (down, unused)
set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33  PULLUP true } [get_ports {JA[3]}];#Sch name = JA4  (shield / up)
...
##Pmod Header JB  (legacy keyboard location - keyboard is on the onboard USB HID)
...
##Pmod Header JC  (PmodAMP2 mono audio, left channel)
