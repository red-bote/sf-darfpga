...
#
# Layout is nested: the .xpr lives at basys3/pooyan_basys3/ and the project
# sources tree is basys3/pooyan_basys3/pooyan_basys3.srcs/.
#
...
mkdir -p "$XPR_DIR" "$CONSTRS_IMPORT" "$SOURCES_IMPORT"
