#!/bin/bash
# Drive Vivado to synthesise and build the Xevious Basys3 bitstream.
#
...
#   vhdl_xevious_de2_de10_lite_2017_05_01/basys3/xevious_basys3.runs/impl_1/xevious_basys3.bit
#
...
XPR="$ROOT/vhdl_xevious_de2_de10_lite_2017_05_01/basys3/xevious_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_xevious_de2_de10_lite_2017_05_01/basys3/xevious_basys3.runs/impl_1/xevious_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else
