...
# The IP is generated here in a throwaway Vivado project named mmcm_12 and
...
XPR_DIR="$(cd "$(dirname "$0")/../../../vhdl_ckong_rev_0_1_2018_06_06/basys3" && pwd)"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/ckong_basys3.srcs/sources_1/imports/clk_wiz_0"
...
cat > "$TCL" <<EOF
create_project mmcm_12 "$WORK" -part $PART -force
