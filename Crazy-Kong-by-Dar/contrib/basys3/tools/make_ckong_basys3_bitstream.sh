#!/bin/bash
# Drive Vivado to synthesise and build the Crazy Kong Basys3 bitstream.
#
# Usage: make_ckong_basys3_bitstream.sh {synth|bitstream}
#
...
#   vhdl_ckong_rev_0_1_2018_06_06/basys3/ckong_basys3.runs/impl_1/ckong_basys3.bit
#
...
XPR="$ROOT/vhdl_ckong_rev_0_1_2018_06_06/basys3/ckong_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_ckong_rev_0_1_2018_06_06/basys3/ckong_basys3.runs/impl_1/ckong_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else
