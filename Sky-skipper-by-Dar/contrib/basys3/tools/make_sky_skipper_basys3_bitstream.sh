#!/bin/bash
# Drive Vivado to synthesise and build the Sky Skipper Basys3 bitstream.
#
# Usage: make_sky_skipper_basys3_bitstream.sh {synth|bitstream}
#
...
#   vhdl_sky_skipper_rev_01_2020_01_28/basys3/sky_skipper_basys3.runs/impl_1/sky_skipper_basys3.bit
#
...
XPR="$ROOT/vhdl_sky_skipper_rev_01_2020_01_28/basys3/sky_skipper_basys3.xpr"
...
WORK=/tmp/sky_skipper_bitstream
mkdir -p "$WORK"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_sky_skipper_rev_01_2020_01_28/basys3/sky_skipper_basys3.runs/impl_1/sky_skipper_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else
