...
# expects them.
#
# The main project's .xpr references two imported files (sky_skipper_basys3.xpr):
...
XPR_DIR="$(cd "$(dirname "$0")/../../../vhdl_sky_skipper_rev_01_2020_01_28/basys3" && pwd)"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/sky_skipper_basys3.srcs/sources_1/imports/clk_wiz_0"
